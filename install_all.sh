...
pip install https://github.com/geonition/django_geojson_rest/tarball/5.6.0
...
pip install https://github.com/geonition/base_page/tarball/4.7.0
pip install https://github.com/geonition/dashboard/tarball/5.2.1
pip install https://github.com/geonition/planproposal/tarball/4.3.1
pip install https://github.com/geonition/auth_page/tarball/4.0.4
pip install https://github.com/geonition/geoforms/tarball/5.6.0
pip install https://github.com/geonition/geodjango-map-layers/tarball/4.2.0
