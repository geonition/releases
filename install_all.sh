...
pip install https://github.com/geonition/base_page/tarball/4.6.1 # updated JQuery, JQuery ui and mozernizer. Styles are in index.html. setup changes for OpenLayers.
