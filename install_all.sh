...
pip install https://github.com/geonition/base_page/tarball/master # updated JQuery, JQuery ui and mozernizer. Styles are in index.html. setup changes for OpenLayers.
...
pip install https://github.com/geonition/geoforms/tarball/master # JQuery moved to base_page. self.id instead of time in slugs. fallback for html5 slider. paragraphs accept html5 tags. OSM admin works with https
