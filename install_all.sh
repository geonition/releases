...
pip install https://github.com/geonition/base_page/tarball/master #city name changed to organization, color inputs used in admin for organization colors
...
pip install https://github.com/geonition/geoforms/tarball/master #html5 widgets moved to geonition_utils, hash changed to page_<nr>
